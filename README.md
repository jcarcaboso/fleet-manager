...
The amd64 Server image is `skorcius/fleet-manager:0.6.6`.
...
- [Extending Fleet](docs/technical-design/extending-fleet.md)
...
- [Fleet Manager 0.6.1 release notes](docs/releases/0.6.1.md)
